...
class TelegramClientManager:
    ...
    def __init__(self, env_path: Optional[str] = None, proxy: Optional[tuple] = None):
        """Initialize the Telegram client manager.

        Args:
            env_path: Path to the .env file. If None, looks in the current directory.
            proxy: Optional proxy tuple for TelegramClient (proxy_type, addr, port, username, password)
